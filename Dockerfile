...
RUN apt-get update -y \
    ...
    libeccodes-tools \
    && cd /code \
    && curl -L https://github.com/USDA-ARS-NWRC/weather_forecast_retrieval/archive/v0.3.3.tar.gz | tar xz \
...
RUN mkdir /data \
    ...
    && cp /code/weather_forecast_retrieval-0.3.3/setup.cfg.pygrib /code/pygrib \
    && mv /code/pygrib/setup.cfg.pygrib /code/pygrib/setup.cfg \
    && python3 setup.py build \
    && python3 setup.py install \
    && cd /code/weather_forecast_retrieval-0.3.3 \
