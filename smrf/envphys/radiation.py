...
def twostream(mu0, S0, tau=0.2, omega=0.85, g=0.3, R0=0.5, d=False):
    ...
    Args:
        ...
        Do not force an error if mu0 is <= 0.0; set all outputs to 0.0 and go on.
    ...
    Returns:
        A List of length 6 containing radiation parameters in the same fashion as:
            [reflectance,
            transmittance,
            direct transmittance,
            upwelling irradiance,
            total irradiance at bottom,
            direct irradiance normal to beam]
