"""
There are many different options for estimating clear sky thermal (long wave) radiation in
...
# the base comparison
methods = ['Marks1979', 'Dilley1998', 'Prata1996', 'Angstrom1918']
...
def main():
    ...
    try:
        ...
        s.distribute['thermal'].correct_cloud = False
