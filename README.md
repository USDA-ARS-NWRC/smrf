...
### Install IPW
Clone IPW [here](https://gitlab.com/ars-snow/ipw) and follow the instructions. Note that setting the WORKDIR environment variable is not required and is replaced by setting the tmp_dir in the configuration file.
